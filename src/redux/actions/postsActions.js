...
const FIREBASE_URL = `https://react-redux-social-media-b9485-default-rtdb.firebaseio.com/posts.json`;
// action constnts
...
export const likePost = (postId, userId) => async (dispatch) => {
	try {
		await axios.patch(
			`https://react-redux-social-media-b9485-default-rtdb.firebaseio.com/posts/${postId}/likes.json`,
			{
				// [userId]: true,
				[userId]: true,
			},
...
export const addComment = (postId, email, commentText) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			`https://react-redux-social-media-b9485-default-rtdb.firebaseio.com/posts/${postId}/comments.json`,
			{
